...
int main( int argc, char** argv)
{
  ...
  if ( argc > 1 )
  {
    ...
    //GeoBase::CGeoPoint point( DEG2RAD(51.16096162263386),DEG2RAD(16.896208535971038)); // wayID = 
    GeoBase::CGeoPoint point( DEG2RAD(51.121398),DEG2RAD(15.906612)); // wayID = 229214577
    //GeoBase::CGeoPoint point( DEG2RAD(51.1237259939271),DEG2RAD(15.915939244701315)); // wayID = 234858257 
