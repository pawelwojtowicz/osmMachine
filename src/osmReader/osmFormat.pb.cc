...
::HeaderBBox* HeaderBlock::release_bbox() {
...
void HeaderBlock::set_allocated_bbox(::HeaderBBox* bbox) {
  delete bbox_;
  bbox_ = bbox;
  if (bbox) {
    set_has_bbox();
...
const ::StringTable& PrimitiveBlock::stringtable() const {
...
::StringTable* PrimitiveBlock::mutable_stringtable() {
  set_has_stringtable();
...
::StringTable* PrimitiveBlock::release_stringtable() {
...
void PrimitiveBlock::set_allocated_stringtable(::StringTable* stringtable) {
  delete stringtable_;
...
const ::Node& PrimitiveGroup::nodes(int index) const {
  // @@protoc_insertion_point(field_get:PrimitiveGroup.nodes)
  return nodes_.Get(index);
}
::Node* PrimitiveGroup::mutable_nodes(int index) {
  // @@protoc_insertion_point(field_mutable:PrimitiveGroup.nodes)
  return nodes_.Mutable(index);
}
::Node* PrimitiveGroup::add_nodes() {
...
::DenseNodes* PrimitiveGroup::release_dense() {
...
void PrimitiveGroup::set_allocated_dense(::DenseNodes* dense) {
  delete dense_;
  dense_ = dense;
  if (dense) {
    set_has_dense();
...
void Node::set_allocated_info(::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
...
::DenseInfo* DenseNodes::release_denseinfo() {
...
void DenseNodes::set_allocated_denseinfo(::DenseInfo* denseinfo) {
  delete denseinfo_;
...
const ::Info& Way::info() const {
  // @@protoc_insertion_point(field_get:Way.info)
  return info_ != NULL ? *info_ : *default_instance_->info_;
}
::Info* Way::mutable_info() {
  set_has_info();
  if (info_ == NULL) {
    info_ = new ::Info;
  }
...
void Way::set_allocated_info(::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
...
const ::Info& Relation::info() const {
  // @@protoc_insertion_point(field_get:Relation.info)
  return info_ != NULL ? *info_ : *default_instance_->info_;
}
::Info* Relation::mutable_info() {
  set_has_info();
  if (info_ == NULL) {
    info_ = new ::Info;
  }
...
void Relation::set_allocated_info(::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
