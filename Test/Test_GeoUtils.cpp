...
{
    osmMachine::CGeoPoint begin(DEG2RAD(10.731498) , DEG2RAD(45.504503) );
    osmMachine::CGeoPoint end(DEG2RAD(10.732161) , DEG2RAD(45.504554));
    osmMachine::CGeoPoint point( DEG2RAD( 10.731421), DEG2RAD(45.505590));
...
TEST( GeoUtils_ProjectPoint2Shape , OnShape2 )
{
    osmMachine::CGeoPoint begin(DEG2RAD(10.731498) , DEG2RAD(45.504503) );
    osmMachine::CGeoPoint end(DEG2RAD(10.732161) , DEG2RAD(45.504554));
    osmMachine::CGeoPoint point( DEG2RAD( 10.732083), DEG2RAD(45.504799));
    osmMachine::CGeoPoint projection;
...
TEST( GeoUtils_ProjectPoint2Shape , OffShape1 )
{
    osmMachine::CGeoPoint begin(DEG2RAD(10.731498) , DEG2RAD(45.504503) );
    osmMachine::CGeoPoint end(DEG2RAD(10.732161) , DEG2RAD(45.504554));
    osmMachine::CGeoPoint point( DEG2RAD( 10.730787), DEG2RAD(45.504891));
    osmMachine::CGeoPoint projection;
...
TEST( GeoUtils_ProjectPoint2Shape , OffShape2 )
{
    osmMachine::CGeoPoint begin(DEG2RAD(10.731498) , DEG2RAD(45.504503) );
    osmMachine::CGeoPoint end(DEG2RAD(10.732161) , DEG2RAD(45.504554));
    osmMachine::CGeoPoint point( DEG2RAD( 10.732967), DEG2RAD(45.505391));
    osmMachine::CGeoPoint projection;
